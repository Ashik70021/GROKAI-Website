                        ...
                        <div className={`transition-all duration-1000 ${
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                <div className="flex items-center space-x-3 sm:space-x-4">
                                    <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-[#00D4FF] rounded-full flex-shrink-0"></div>
                            ...
                            <div className="relative bg-gradient-to-br from-[#1C1C1A] to-[#0F0F0D] rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-gray-800">
                                ...
                                <div className="relative h-64 sm:h-80 lg:h-96 flex items-center justify-center">
                                    ...
                                    <div className="relative">
                                        <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 bg-gradient-to-r from-[#00D4FF] to-[#0099CC] rounded-full flex items-center justify-center animate-pulse">
                                        ...
                                        <div className="absolute inset-0 animate-spin" style={{ animationDuration: '20s' }}>
                                            <div className="absolute -top-6 sm:-top-8 left-1/2 transform -translate-x-1/2 w-3 h-3 sm:w-4 sm:h-4 bg-[#00D4FF] rounded-full"></div>
                                            <div className="absolute top-1/2 -right-6 sm:-right-8 transform -translate-y-1/2 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-[#0099CC] rounded-full"></div>
                                            <div className="absolute -bottom-6 sm:-bottom-8 left-1/2 transform -translate-x-1/2 w-3 h-3 sm:w-4 sm:h-4 bg-[#00D4FF] rounded-full"></div>
                                            <div className="absolute top-1/2 -left-6 sm:-left-8 transform -translate-y-1/2 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-[#0099CC] rounded-full"></div>
                                        </div>
                                        ...
                                        <div className="absolute inset-0">
                                            <svg className="w-full h-full" viewBox="0 0 200 200">
                                                <g className="animate-pulse">
                                                    <line x1="100" y1="50" x2="100" y2="100" stroke="#00D4FF" strokeWidth="1.5" opacity="0.6"/>
                                                    <line x1="150" y1="100" x2="100" y2="100" stroke="#00D4FF" strokeWidth="1.5" opacity="0.6"/>
                                                    <line x1="100" y1="150" x2="100" y2="100" stroke="#00D4FF" strokeWidth="1.5" opacity="0.6"/>
                                                    <line x1="50" y1="100" x2="100" y2="100" stroke="#00D4FF" strokeWidth="1.5" opacity="0.6"/>
                                                </g>
                                            </svg>
                                        </div>
                                    </div>
                                ...
                                <div className="absolute top-2 sm:top-4 right-2 sm:right-4 w-4 h-4 sm:w-6 sm:h-6 bg-[#00D4FF]/20 rounded-full animate-bounce" style={{ animationDelay: '0s' }}></div>
                                <div className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4 w-3 h-3 sm:w-4 sm:h-4 bg-[#0099CC]/20 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
                                <div className="absolute top-1/3 left-4 sm:left-6 lg:left-8 w-3.5 h-3.5 sm:w-5 sm:h-5 bg-[#00D4FF]/20 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
                            </div>
                        </div>
                    </div>
                </div>
