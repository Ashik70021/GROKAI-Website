    ...
    return (
        <div className="bg-[#161614] min-h-screen">
            ...
            <section className="py-20" ref={visionRef}>
                <div className="max-w-[1800px] mx-auto px-32">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className={`transition-all duration-1000 ${
                            ...
                            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-8">
                                Our <span className="bg-gradient-to-r from-[#00D4FF] to-[#0099CC] bg-clip-text text-transparent">Vision</span>
                            </h1>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <span className="text-lg text-gray-200 font-medium">Easy to Use</span>
                                </div>
                                <div className="flex items-center space-x-4">
                                    <div className="w-3 h-3 bg-[#00D4FF] rounded-full"></div>
                                    <span className="text-lg text-gray-200 font-medium">Powerful</span>
                                </div>
                                <div className="flex items-center space-x-4">
                                    <div className="w-3 h-3 bg-[#00D4FF] rounded-full"></div>
                                    <span className="text-lg text-gray-200 font-medium">Reliable</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={`relative transition-all duration-1000 ${
                            ...
                            <div className="relative bg-gradient-to-br from-[#1C1C1A] to-[#0F0F0D] rounded-3xl p-8 border border-gray-800">
                                {/* Futuristic AI Illustration */}
                                <div className="relative h-96 flex items-center justify-center">
                                    {/* Central AI Core */}
                                    <div className="relative">
                                        <div className="w-32 h-32 bg-gradient-to-r from-[#00D4FF] to-[#0099CC] rounded-full flex items-center justify-center animate-pulse">
                                            <div className="w-20 h-20 bg-[#161614] rounded-full flex items-center justify-center">
                                        ...
                                        <div className="absolute inset-0 animate-spin" style={{ animationDuration: '20s' }}>
                                            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#00D4FF] rounded-full"></div>
                                            <div className="absolute top-1/2 -right-8 transform -translate-y-1/2 w-3 h-3 bg-[#0099CC] rounded-full"></div>
                                            <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#00D4FF] rounded-full"></div>
                                            <div className="absolute top-1/2 -left-8 transform -translate-y-1/2 w-3 h-3 bg-[#0099CC] rounded-full"></div>
                                        </div>
                                        ...
                                        <div className="absolute inset-0">
                                            <svg className="w-full h-full" viewBox="0 0 200 200">
                                                <g className="animate-pulse">
                                                    <line x1="100" y1="50" x2="100" y2="100" stroke="#00D4FF" strokeWidth="2" opacity="0.6"/>
                                                    <line x1="150" y1="100" x2="100" y2="100" stroke="#00D4FF" strokeWidth="2" opacity="0.6"/>
                                                    <line x1="100" y1="150" x2="100" y2="100" stroke="#00D4FF" strokeWidth="2" opacity="0.6"/>
                                                    <line x1="50" y1="100" x2="100" y2="100" stroke="#00D4FF" strokeWidth="2" opacity="0.6"/>
                                                </g>
                                            </svg>
                                        </div>
                                    </div>
                                ...
                                <div className="absolute top-4 right-4 w-6 h-6 bg-[#00D4FF]/20 rounded-full animate-bounce" style={{ animationDelay: '0s' }}></div>
                                <div className="absolute bottom-4 left-4 w-4 h-4 bg-[#0099CC]/20 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
                                <div className="absolute top-1/3 left-8 w-5 h-5 bg-[#00D4FF]/20 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Goals Section */}
            <section className="py-20" ref={goalsRef}>
                <div className="max-w-[1400px] mx-auto px-8">
                    ...
                    <div className={`text-center mb-20 transition-all duration-1000 ${
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                            Our <span className="bg-gradient-to-r from-[#00D4FF] to-[#0099CC] bg-clip-text text-transparent">Goals</span>
                        </h2>
                    ...
                    <div className="relative">
                        {/* Timeline Line */}
                        <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-[#00D4FF] to-[#0099CC]"></div>
