                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center space-x-3 mb-6">
                            <img src="/Images/grokai1.png" alt="GROKAI Logo" className="w-10 h-10 object-contain"/>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-white rounded-lg flex items-center justify-center transition-all duration-300 group">
                                <svg className="w-5 h-5 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">About GROKAI</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Whitepaper</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">How to Buy</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Contract Address</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Analyze Data</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Automate Tasks</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Decision Making</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Drive Creativity</a></li>
